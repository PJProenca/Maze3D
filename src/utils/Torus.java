...
public class Torus extends Shape3D {
  public Torus(double r1, double r2) {
    ...
    // Generate the vertices of the initial slice sing a composite transformation.
    ...
    // Rotate successively the vertices of the slice around the Y axis to construct a new slice.
    // With the vertices of the new slice and the vertices of the last one, construct the quad faces of the geometry. 
    ...
    // Transform the geometry to a GeometryInfo object to generate the normals automatically.
